...
const DisplayPanel = () => {
  ...
  const viewHeading = document.querySelector('#widget-heading')  // this is a reference to the heading (change the heading)
  // any of the widget containers:
  // all of these references, reference the panels
  let managers = null;
  let employees = null;
